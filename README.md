...
## Организация памяти
Память интрукций однородная - состоит только из последовательности команд, вследствие отсутствия функций и системы прерываний.

Память данных реализована следующим образом: первые 3 ячейки памяти размаплены под ввод/вывод (00 - вывод, 01 - символьный вывод, 02 - ввод), далее память полностью выделена под переменные. Доступ к переменным реализован за счет ссылок, которые заполняются в процессе линковки.
...
|-------------------|-------|-----|-----------|-------------|--------|-------|---------|
| Колесникова С.А.  | hello | 24  |  111      | 24          | 23     | 58    | -       |
| Колесникова С.А.  | cat   | 7   |    27     | 7           | 24     | 54    | -       |
| Колесникова С.А.  | prob2 | 26  |    90     | 26          | 422    | 931   | -       |